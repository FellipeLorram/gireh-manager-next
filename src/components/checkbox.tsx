...
export const Checkbox = forwardRef<HTMLInputElement, Props>(({ label, error, ...props }, ref) => {
    return (
        <div className="inline-flex items-center mb-4">
            ...
            >
                <input
                    ...
                    h-5 w-5 
                    cursor-pointer 
                    appearance-none rounded-md border border-blue-gray-200 
                    ...
                    before:opacity-0 before:transition-opacity checked:border-blue-600 
                    checked:bg-blue-600 checked:before:bg-blue-600 hover:before:opacity-10"
                    ref={ref}
                />
